...
public class ListMasjid extends ListActivity  {
    ...
    public void onCreate(Bundle icicle) {
      ...
      String NamaMesjid[] = {"Abu Bakar Ash Shidiq"
        		,"Al akhbar"
        		,"Al Ikhlas"
        		,"AL Husna"
        		,"Al Istiqamah"
        		...
        		,"Khusnul Khatimah"
        		,"Masjid Bimantara"
        		,"Masjid Islamic Center Indonesia"
        		,"Masjid Baitul Muhajirin"
        		,"MASJID RAYA AL-ITTIHAD"
      ...
      input = (EditText) findViewById(R.id.editText1);
		...
		input.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int arg1, int arg2, int arg3) {
            	...
            	ListMasjid.this.adapter.getFilter().filter(s);
            }
